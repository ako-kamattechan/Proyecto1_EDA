 ...
 * @since 1.7 * 14
 */
public final class JavaDefaultSort{
    public static int operations;
    /**
     * Prevents instantiation.
     */
    private JavaDefaultSort() {}
    ...
    private static <A> void sort(Class<?> elemType, A array, long offset, int low, int high, JavaDefaultSort.SortOperation<A> so) {
    ...
    private static <A> int[] partition(Class<?> elemType, A array, long offset, int low, int high, int pivotIndex1, int pivotIndex2, JavaDefaultSort.PartitionOperation<A> po) {
    ...
    //modified sort  method, no parallelism used
    public static void sort(int[] a) {
        sort(null, a, 0, 0, a.length);
    }

    static void sort(JavaDefaultSort.Sorter sorter, int[] a, int bits, int low, int high) {
        operations++;
        while (true) {
            operations+=2;
            ...
            if (size < MAX_MIXED_INSERTION_SORT_SIZE + bits && (bits & 1) > 0) {
                sort(int.class, a, Unsafe.ARRAY_INT_BASE_OFFSET, low, high, JavaDefaultSort::mixedInsertionSort);
                return;
            }
            ...
            if (size < MAX_INSERTION_SORT_SIZE) {
                sort(int.class, a, Unsafe.ARRAY_INT_BASE_OFFSET, low, high, JavaDefaultSort::insertionSort);
                return;
            }
             ...
             */
            operations++;
            if (a[e5] < a[e2]) { int t = a[e5]; a[e5] = a[e2]; a[e2] = t; operations+=3;}
            operations++;
            if (a[e4] < a[e1]) { int t = a[e4]; a[e4] = a[e1]; a[e1] = t; operations+=3;}
            operations++;
            if (a[e5] < a[e4]) { int t = a[e5]; a[e5] = a[e4]; a[e4] = t; operations+=3;}
            operations++;
            if (a[e2] < a[e1]) { int t = a[e2]; a[e2] = a[e1]; a[e1] = t; operations+=3;}
            operations++;
            if (a[e4] < a[e2]) { int t = a[e4]; a[e4] = a[e2]; a[e2] = t; operations+=3;}
            ...
            if (a[e1] < a[e2] && a[e2] < a[e3] && a[e3] < a[e4] && a[e4] < a[e5]) {
                 ...
                 */
                operations++;
                int[] pivotIndices = partition(int.class, a, Unsafe.ARRAY_INT_BASE_OFFSET, low, high, e1, e5, JavaDefaultSort::partitionDualPivot);
                operations+=2;
                 ...
                 */
                operations++;
                int[] pivotIndices = partition(int.class, a, Unsafe.ARRAY_INT_BASE_OFFSET, low, high, e3, e3, JavaDefaultSort::partitionSinglePivot);
                operations+=2;
                lower = pivotIndices[0];
                upper = pivotIndices[1];
                /*
    ...
    private static int[] partitionDualPivot(int[] a, int low, int high, int pivotIndex1, int pivotIndex2) {
        ...
        for (int unused = --lower, k = ++upper; --k > lower; ) {
            ...
            if (ak < pivot1) { // Move a[k] to the left side
                ...
                operations++;
                if (ak > pivot2) { // Move a[k] to the right side
                    operations += 2;
                    a[k] = a[--upper];
                    a[upper] = ak;
                }
     ...
     */
    private static boolean tryMergeRuns(JavaDefaultSort.Sorter sorter, int[] a, int low, int size) {
    ...
    private static int[] mergeRuns(int[] a, int[] b, int offset,
        ...
        if (parallel && hi - lo > MIN_RUN_COUNT) {
            operations+=3;
            JavaDefaultSort.RunMerger merger = new JavaDefaultSort.RunMerger(a, b, offset, 0, run, mi, hi).forkMe();
        ...
        operations++;
        if (parallel) {
            new JavaDefaultSort.Merger(null, dst, k, a1, lo1, hi1, a2, lo2, hi2).invoke();
        } else {
     ...
     */
    private static void mergeParts(JavaDefaultSort.Merger merger, int[] dst, int k,
...
// [long]
    ...
    static void sort(long[] a, int parallelism, int low, int high) {
        ...
        if (parallelism > 1 && size > MIN_PARALLEL_SORT_SIZE) {
            ...
            new JavaDefaultSort.Sorter(null, a, b, low, size, low, depth).invoke();
        } else {
     ...
     * @param high the index of the last element, exclusive, to be sorted
     */
    static void sort(JavaDefaultSort.Sorter sorter, long[] a, int bits, int low, int high) {
        while (true) {
            int end = high - 1, size = high - low;
             ...
             */
            if (size < MAX_MIXED_INSERTION_SORT_SIZE + bits && (bits & 1) > 0) {
                sort(long.class, a, Unsafe.ARRAY_LONG_BASE_OFFSET, low, high, JavaDefaultSort::mixedInsertionSort);
                return;
            }
             ...
             */
            if (size < MAX_INSERTION_SORT_SIZE) {
                sort(long.class, a, Unsafe.ARRAY_LONG_BASE_OFFSET, low, high, JavaDefaultSort::insertionSort);
                return;
            }
            ...
            if (a[e1] < a[e2] && a[e2] < a[e3] && a[e3] < a[e4] && a[e4] < a[e5]) {
                 ...
                 * of tertiles. Note, that pivot1 < pivot2.
                 */
                int[] pivotIndices = partition(long.class, a, Unsafe.ARRAY_LONG_BASE_OFFSET, low, high, e1, e5, JavaDefaultSort::partitionDualPivot);
                lower = pivotIndices[0];
                upper = pivotIndices[1];
                /*
                 * Sort non-left parts recursively (possibly in parallel),
                 ...
                 * This value is inexpensive approximation of the median.
                 */
                int[] pivotIndices = partition(long.class, a, Unsafe.ARRAY_LONG_BASE_OFFSET, low, high, e3, e3, JavaDefaultSort::partitionSinglePivot);
                lower = pivotIndices[0];
                upper = pivotIndices[1];
                /*
                 * Sort the right part (possibly in parallel), excluding
     ...
     * @return true if finally sorted, false otherwise
     */
    private static boolean tryMergeRuns(JavaDefaultSort.Sorter sorter, long[] a, int low, int size) {
     ...
     * @param hi2 the end index of the second part, exclusive
     */
    private static void mergeParts(JavaDefaultSort.Merger merger, long[] dst, int k,
...
// [float]
     ...
     * @return true if finally sorted, false otherwise
     */
    private static boolean tryMergeRuns(JavaDefaultSort.Sorter sorter, float[] a, int low, int size) {
     ...
     * @param hi2 the end index of the second part, exclusive
     */
    private static void mergeParts(JavaDefaultSort.Merger merger, float[] dst, int k,
...
// [double]
     ...
     * @param high the index of the last element, exclusive, to be sorted
     */
    static void sort(JavaDefaultSort.Sorter sorter, double[] a, int bits, int low, int high) {
        while (true) {
            int end = high - 1, size = high - low;
            /*
             * Run mixed insertion sort on small non-leftmost parts.
             */
            if (size < MAX_MIXED_INSERTION_SORT_SIZE + bits && (bits & 1) > 0) {
                sort(double.class, a, Unsafe.ARRAY_DOUBLE_BASE_OFFSET, low, high, JavaDefaultSort::mixedInsertionSort);
                return;
            }
             ...
             */
            if (size < MAX_INSERTION_SORT_SIZE) {
                sort(double.class, a, Unsafe.ARRAY_DOUBLE_BASE_OFFSET, low, high, JavaDefaultSort::insertionSort);
                return;
            }
            ...
            if (a[e1] < a[e2] && a[e2] < a[e3] && a[e3] < a[e4] && a[e4] < a[e5]) {
                 ...
                 * of tertiles. Note, that pivot1 < pivot2.
                 */
                int[] pivotIndices = partition(double.class, a, Unsafe.ARRAY_DOUBLE_BASE_OFFSET, low, high, e1, e5, JavaDefaultSort::partitionDualPivot);
                lower = pivotIndices[0];
                upper = pivotIndices[1];
                /*
                 * Sort non-left parts recursively (possibly in parallel),
                 ...
                 * This value is inexpensive approximation of the median.
                 */
                int[] pivotIndices = partition(double.class, a, Unsafe.ARRAY_DOUBLE_BASE_OFFSET, low, high, e3, e3, JavaDefaultSort::partitionSinglePivot);
                lower = pivotIndices[0];
                upper = pivotIndices[1];
   ...
   // @ForceInline
     ...
     * @return true if finally sorted, false otherwise
     */
    private static boolean tryMergeRuns(JavaDefaultSort.Sorter sorter, double[] a, int low, int size) {
     ...
     * @param hi2 the end index of the second part, exclusive
     */
    private static void mergeParts(JavaDefaultSort.Merger merger, double[] dst, int k,
...
// [class]
    ...
    private static final class Sorter extends CountedCompleter<Void> {
        ...
        public final void compute() {
            if (depth < 0) {
                setPendingCount(2);
                int half = size >> 1;
                new JavaDefaultSort.Sorter(this, b, a, low, half, offset, depth + 1).fork();
                new JavaDefaultSort.Sorter(this, b, a, low + half, size - half, offset, depth + 1).compute();
            } else {
                if (a instanceof int[]) {
        ...
        public final void onCompletion(CountedCompleter<?> caller) {
            if (depth < 0) {
                ...
                new JavaDefaultSort.Merger(null,
                        a,
                        src ? low : low - offset,
                        b,
                        src ? low - offset : low,
        ...
        private void forkSorter(int depth, int low, int high) {
            ...
            new JavaDefaultSort.Sorter(this, a, b, low, high - low, offset, depth).fork();
        }
    }
    ...
    private static final class Merger extends CountedCompleter<Void> {
        ...
        private void forkMerger(Object dst, int k,
                                Object a1, int lo1, int hi1, Object a2, int lo2, int hi2) {
            addToPendingCount(1);
            new JavaDefaultSort.Merger(this, dst, k, a1, lo1, hi1, a2, lo2, hi2).fork();
        }
    }
    ...
    private static final class RunMerger extends RecursiveTask<Object> {
        ...
        private JavaDefaultSort.RunMerger forkMe() {
            fork();
            return this;
        }
